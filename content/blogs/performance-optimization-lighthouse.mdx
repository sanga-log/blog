...
![개선 전 Lighthouse 카테고리 점수 — Performance 52, Accessibility 77, Best Practices 78, SEO 83](/images/perf-before-scores.png)

![개선 전 핵심 지표 — LCP 6.6s, CLS 0.737 (FCP 0.5s, TBT 0ms)](/images/perf-before-metrics.png)

LCP가 **6.6초**. Good 기준이 2.5초 이하임을 감안하면 한참 벗어난 수치였습니다. 예상은 했지만 막상 숫자로 보니 더 심각하게 느껴졌습니다.

![Lighthouse 진단 항목 — 레이아웃 시프트, LCP 요소, 차세대 이미지 포맷, 이미지 크기 등 개선 제안](/images/perf-diagnostics.png)

![LCP 요소 상세 — 히어로 이미지의 Load Delay 35%(2,200ms), Load Time 56%(3,450ms)로 6,200ms 소요](/images/perf-lcp-element.png)
...
![LCP 개선 후 — Performance 76, LCP 0.9s (CLS는 아직 0.73)](/images/perf-lcp-after.png)
...
![CLS 진단 — div.footer 레이아웃 시프트 0.730, 다수 이미지의 크기 미지정(Media element lacking an explicit size)](/images/perf-cls-diagnostics.png)
...
![CLS 개선 후 — Performance 99, LCP 0.9s, CLS 0](/images/perf-cls-after.png)
...
![개선 후 Lighthouse 카테고리 점수 — Performance 99, Accessibility 87, Best Practices 78, SEO 92](/images/perf-after-scores.png)
