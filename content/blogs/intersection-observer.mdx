...
![Network 탭에서 확인한 느린 API — 단일 요청 응답 대기 시간이 33.89초](/images/lighthouse-time.png)
...
![Lighthouse 측정 결과 (개선 전) — Performance 26점, TBT 3,180ms, LCP 51.1s](/images/lighthouse-before.png)
...
![Lighthouse 측정 결과 (개선 후) — Performance 48점, TBT 320ms (3,180ms → 320ms, 약 90%↓)](/images/lighthouse-after.png)
